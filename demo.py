    ...
    while True:
        ...
        match cmds[0]:
            ...
            case "5":
                ...
                key = input(
                    "There are two versions of Cuckoo Filter implementation, do you wanna try the one generated by AI? ([y]/n) "
                )
                ai = True
                if key == "n":
                    ai = False
                    ...
                    print(
                        "You did not type 'n', will continue with AI generated version."
                    )
                run_cuckoo_filter(datasets[cmds[1]], ai)
            case "6":
                if name_list is None or check_list is None:
                    name_list, check_list = prepare_data_for_simple_search(
                        datasets[cmds[1]]
            ...
            case "7":
                ...
                ai = True
                if key.lower() == "n" or key.lower() == "no":
                    ai = False
                else:
                    print(
                        "You did not type 'n', will continue with AI generated version."
